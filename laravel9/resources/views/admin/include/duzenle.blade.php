                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <form action="{{ route('duzenlepost',[$modulBilgisi->selflink,$veriler->id ])}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <label>Başlık</label>
                                        <input type="text" class="form-control input-default" value="{{ $veriler->başlık }}" placeholder="Başlık" name="başlık" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label>Anahtar</label>
                                        <input type="text" class="form-control input-flat" value="{{ $veriler->anahtar }}" placeholder="Anahtar" name="anahtar" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Sıra No</label>
                                        <input type="number" class="form-control input-default" value="{{ $veriler->sire_no }}" placeholder="Sıra No" name="sira_no" required>
                                    </div>
                                    <div class="form-group">
